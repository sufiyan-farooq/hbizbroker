      ...
      <div className="mx-auto sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 pr-4">
          ...
          <nav className="hidden lg:flex space-x-8">
            <Link href="/" className="text-gray-300 hover:text-white transition-colors relative group py-2" style={{ fontFamily: 'PoppinRegular' }}>
              Home
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#5da0b1] transition-all duration-300 group-hover:w-full"></span>
            </Link>
            <Link href="/whywork" className="text-gray-300 hover:text-white transition-colors relative group py-2" style={{ fontFamily: 'PoppinRegular' }}>
              Why Work with Us
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#5da0b1] transition-all duration-300 group-hover:w-full"></span>
            </Link>
            <Link href="/business" className="text-gray-300 hover:text-white transition-colors relative group py-2" style={{ fontFamily: 'PoppinRegular' }}>
              Businesses For Sale
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#5da0b1] transition-all duration-300 group-hover:w-full"></span>
            </Link>
            <Link href="/consultation" className="text-gray-300 hover:text-white transition-colors relative group py-2" style={{ fontFamily: 'PoppinRegular' }}>
              Consultation Services
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#5da0b1] transition-all duration-300 group-hover:w-full"></span>
            </Link>
            <Link href="/podcast" className="text-gray-300 hover:text-white transition-colors relative group py-2" style={{ fontFamily: 'PoppinRegular' }}>
              Podcast
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-[#5da0b1] transition-all duration-300 group-hover:w-full"></span>
            </Link>
          </nav>
          ...
          <nav className="flex flex-col space-y-4">
            {[
              ...
              <Link
                ...
                className="text-gray-300 hover:text-white transition-colors px-4 py-2 relative group"
